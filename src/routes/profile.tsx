    ...
    <AppShell>
      <div className="animate-reveal space-y-7 pb-4">
        ...
        <button
          ...
          className="w-full rounded-2xl border border-red-200 bg-red-50 py-[15px] text-[15px] font-semibold text-red-500 transition-all hover:bg-red-100 active:scale-[0.98]"
        >
          Sign Out
        </button>
